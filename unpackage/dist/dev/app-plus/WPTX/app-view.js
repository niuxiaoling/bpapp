...
cs.push("./pages/main/main.vue.wxml:rich-text:11:8")
var eN=_mz(z,'rich-text',['class',20,'nodes',1],[],e,s,gg)
cs.pop()
_(tM,eN)
cs.pop()
_(oB,tM)
...
var cW=_mz(z,'navigator',['class',29,'url',1],[],fS,oR,gg)
cs.push("./pages/main/main.vue.wxml:image:16:12")
var oX=_mz(z,'image',['class',31,'mode',1,'src',2],[],fS,oR,gg)
cs.pop()
_(cW,oX)
cs.push("./pages/main/main.vue.wxml:text:17:12")
var lY=_n('text')
_rz(z,lY,'class',34,fS,oR,gg)
var aZ=_oz(z,35,fS,oR,gg)
_(lY,aZ)
cs.pop()
_(cW,lY)
cs.pop()
...
oP.wxXCkey=2
_2z(z,25,xQ,e,s,gg,oP,'v','index','v')
cs.pop()
cs.pop()
_(oB,bO)
cs.pop()
